...
chain = (
        PROMPT_TEMPLATE
        | ChatOpenAI(model="gpt-4o-mini", temperature=0, api_key="sk-zb3-SozyMoIMOZC4OkNjug", base_url="https://aiverse-row.ludp.lenovo.com/ics-apps/projects/115/rowcash-test/aiverse/endpoint/v1")
)
